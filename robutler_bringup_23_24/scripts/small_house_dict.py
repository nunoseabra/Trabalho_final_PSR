...
def object_dictionary():
    obj_bedroom_sections = {
        ...
        "bed": {
            "Coords": [-6.234550, 1.841569, 0.772517, -0.007876, 0.003780, 0],
            "Size": "Big",
        },
        "bedside_table_left": {
        ...
        #"bed_table_on_top": {
        #    "Coords": [-8.996136, 2.048792, 1.187709, 0.000877, -0.003197, 0.71],
        #    "Size": "Small",
        #},
        "in_the_open": {
    ...
    obj_gym_sections = {
        "gym_table": {
            "Coords": [-0.561677, 3.965602, 0,468291, -0.042383, 0.008629, 0],
            "Size": "Small",
        },
    ...
    obj_living_room_sections = {
        ...
        "in_the_open": {
            "Coords": [2.631333, -3.786115, 0.066227, 0, 0, 2.034155],
            "Size": "Big",
        },
    }
